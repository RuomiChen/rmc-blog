...
spring:
  datasource:
    url: jdbc:mysql://localhost:3306/guiguxiaozhi?useUnicode=true&charactreEncoding=UTF-8&serverTimezone=Asia/Shanghai&useSSL=false
    username: root
    password: 123456
...
public Flux<String> chat(@RequestBody chatForm chatForm){
  return xiaozhigent.chat(chatForm.getMemoryId(), chatForm.getMessage());
}
```